...
public class ProblemListAdapterManagement extends RecyclerView.Adapter<ProblemListAdapterManagement.ViewHolder>{


    List<Problem> problems;
    Context contex;

    public ProblemListAdapterManagement(List<Problem> problems, Context contex) {
